    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                ...
                <b>Place: Kintamani Highlands, North Bali, Indonesia. This coffee is grown at an altitude between 3,200 and 3,900 feet, under shade trees, with orange and tangerine trees planted
                ...
                <b>Process</b>: The coffee is organically farmed, although not certified. Harvesting is done from May to October and only ripe fruit is picked. The coffee must contain 95% red fruit to be accepted for processing. The coffee is semi-washed, with a two-step sun drying process.
            ...
            [
                ...
                <b>Place</b>: Costa Rica, Guatemala, Papua New Guinea, Sumatra
                <b>People</b>: Our experienced roasters prepare this decaf blend to work well as a drip coffee and provide a balanced profile that lends well to lattes, cappuccinos, or as a straight shot.
                <b>Process<b>: Each origin coffee is carefully roasted individually to its optimum level and then combined in the right proportion to create the final blend. There are a total of four coffees, one roasted at two levels, resulting in five individual blend components.
            ...
            [
                ...
                <b>Place</b>: Cerrado region, Brazil.
                <b>People</b>: Brazil is the largest producer of coffee in the world. The Cerrado region is well known for its uniquely processed coffee.
            ...
            [
                ...
                <b>Process</b>: Due to the restricted area qualified to grow this exceptional coffee, only 4000 barrels (650,000 pounds) are produced per year. The beans are handpicked, and very limited amounts of machinery can be employed in its\' processing. Most production is by hand.
